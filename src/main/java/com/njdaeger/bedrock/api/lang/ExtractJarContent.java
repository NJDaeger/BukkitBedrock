 ...
 * @author Brian Cole
 */
public class ExtractJarContent {
     ...
     */
    public ExtractJarContent(String sourceDirectory, File writeDirectory) {
        try {
            extract(sourceDirectory, writeDirectory.getAbsolutePath());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
